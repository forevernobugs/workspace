...
SwipeSlide.prototype = {
	...
	touchMove: function(a) {
		if (this.touch.start && (this.touch.end = this.trackTouch(a), a = this.distance(this.isVertical), "undefined" == typeof this.isScroll && (this.isScroll = Math.abs(a) < Math.abs(this.distance(!this.isVertical))), !this.isScroll)) return this.stopAutoPlay(),
		this.move(this.withResistance(a), 0),
		!1
	},
	touchEnd: function() {
		if (!this.isScroll) {
