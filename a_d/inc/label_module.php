...
if($jobs=='show')
{
	...
	$label[$all_label[0]]="<SCRIPT LANGUAGE='JavaScript' src='$webdb[www_url]/images/default/label_jq.js'></SCRIPT>
							<script type='text/javascript' src='$webdb[www_url]/admin/js/jquery.artDialog.js?skin=default'></script>
<script type='text/javascript' src='$webdb[www_url]/admin/js/iframeTools.js'></script>
	<SCRIPT LANGUAGE='JavaScript' src='$webdb[www_url]/images/default/label.js'></SCRIPT><SCRIPT LANGUAGE='JavaScript'>
