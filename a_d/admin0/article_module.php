...
{	
	...
	if(strstr($_rs[field_name],"select_"))
		$pidanshow[1]=" checked ";
	else
		$pidanshow[0]=" checked ";
...
{	
	...
	if($postdb[pidan]!==false)
	{
		$pidan=$postdb[pidan];
		if($pidan==1&&!strstr($postdb[field_name],"select_"))
		{
			$postdb[field_name]="select_".$postdb[field_name];
		}
		else if($pidan==0&&strstr($postdb[field_name],"select_"))
		{
			$postdb[field_name]=substr($postdb[field_name],7);
