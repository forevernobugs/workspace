  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo url('admin/links/index'); ?>">链接管理</a></li>
        <li class="active"><a href="<?php echo url('admin/links/edit'); ?>">编辑链接</a></li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <form method="post"  action="<?php echo url('admin/links/edit'); ?>" id="edit">
                <div class="box-body">
                  <div class="form-group">
                    <label for="link_name" id="uname_label" class="">标题</label>
                    <input class="form-control" id="link_name" name="link_name" value="<?php echo $linkInfo['name']; ?>" placeholder="链接标题" type="text">
                    <input name="id" hidden="hidden" value="<?php echo $linkInfo['id']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="link_url" class="">URL</label>
                    <input class="form-control" id="link_url" name="link_url" value="<?php echo $linkInfo['url']; ?>" placeholder="链接地址" type="text">
                  </div>                  
                  <div class="form-group">
                    <label for="target" class="">打开方式</label>
                    <select class="form-control" id="target" name="target">
                      <?php if($linkInfo['target'] == '_blank'): ?>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name="description" id="description" value="<?php echo $linkInfo['description']; ?>" placeholder="链接描述" type="text">
                  </div>
                  <div class="form-group">
                    <label for="visible" class="">是否显示</label>
                    <select class="form-control" id="visible" name="visible">
                      <?php if($linkInfo['visible'] == 'Y'): ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="box-body cover_show">
                      <div class='form-group'>
                        <img class='cover_path' style='max-height:150px;' src="ROOT_PATH<?php echo $linkInfo['image']; ?>">
                      </div>
                    </div>
