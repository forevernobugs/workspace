<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"C:\phpStudy\PHPTutorial\WWW\shop/application/admin\view\goods\goodsedit.html";i:1557154107;s:74:"C:\phpStudy\PHPTutorial\WWW\shop/application/admin\view\common\header.html";i:1555420220;s:74:"C:\phpStudy\PHPTutorial\WWW\shop/application/admin\view\common\navbar.html";i:1471616304;s:74:"C:\phpStudy\PHPTutorial\WWW\shop/application/admin\view\common\footer.html";i:1556075601;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <form action="<?php echo url('goodsEdit'); ?>" method="post" id="addPost">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="form-group">
                <input name="id" hidden="hidden" value="<?php echo $goodsInfo['id']; ?>">
                <input id="title" name="name" value="<?php echo $goodsInfo['name']; ?>" class="form-control" placeholder="商品名称">
              </div>
              <div class="form-group">
                  <textarea name="description" rows="2" placeholder="商品描述" class="form-control"><?php echo $goodsInfo['description']; ?></textarea>
              </div>
              <div class="form-group">
                  <script type="text/plain" id="editor" name="content" style="height:400px;"><?php echo $goodsInfo['content']; ?></script>
              </div>
              <!--扩展表单-->
              <div class="form-extend">
                <div class="form-group">
                    <label>库存</label>
                    <input name="num" type="text" value="<?php echo $goodsInfo['num']; ?>" placeholder="库存" class="form-control" >
                </div>
                <div class="form-group">
                    <label>价格</label>
                    <input name="price" type="text" value="<?php echo $goodsInfo['price']; ?>" placeholder="价格" class="form-control" >
                </div>
                <div class="form-group">
                    <label>点击数</label>
                    <input name="click_count" type="text" value="<?php echo $goodsInfo['click_count']; ?>" placeholder="商品点击数" class="form-control" >
                </div>
                <div class="form-group">
                    <label>销售数量</label>
                    <input name="sell_num" type="text"  value="<?php echo $goodsInfo['sell_num']; ?>" placeholder="销售数量" class="form-control" >
                </div>
                <div class="form-group">
                    <label>规格型号</label>
                    <input name="standard" type="text" value="<?php echo $goodsInfo['standard']; ?>" placeholder="规格型号" class="form-control" >
                </div>
              </div>
            </div>
            <!-- /.box-body -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                    <div class="radio" style="width:180px;float:left">
                      精品：
                      <label>
                        <input name="is_best" type="radio" <?php if($goodsInfo['is_best'] == '1'): ?> checked="checked" <?php endif; ?> value="1">是
                      </label>
                      &nbsp;
                      <label>
                        <input name="is_best" type="radio" <?php if($goodsInfo['is_best'] == '0'): ?> checked="checked" <?php endif; ?> value="0">否
                      </label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="radio" style="width:180px;float:left">
                      新品：
                      <label>
                        <input name="is_new" type="radio" <?php if($goodsInfo['is_new'] == '1'): ?> checked="checked" <?php endif; ?> value="1">是
                      </label>
                      &nbsp;
                      <label>
                        <input name="is_new" type="radio" <?php if($goodsInfo['is_new'] == '0'): ?> checked="checked" <?php endif; ?> value="0"  >否
                      </label>
                    </div>
                </div>
                <div style="clear:both;"></div>
                <div class="form-group">
                      <div class="radio" style="width:180px;float:left">
                        热销：
                        <label>
                          <input name="is_hot" type="radio" <?php if($goodsInfo['is_hot'] == '1'): ?> checked="checked" <?php endif; ?> value="1">是
                        </label>
                        &nbsp;
                        <label>
                          <input name="is_hot" type="radio" <?php if($goodsInfo['is_hot'] == '0'): ?> checked="checked" <?php endif; ?> value="0" >否
                        </label>
                      </div>
                </div>
                <div style="clear:both;"></div>
            ...
            <div class="box-body no-padding">
              <div class="box-body">
                <div id="uploader-demo">
                    <!--用来存放item-->
                    <input type="hidden" name="cover_path" value="<?php echo $goodsInfo['cover_path']; ?>" class="cover_path">
                    <div id="cover_path" class="uploader-list">
                      <div class="file-item thumbnail upload-state-done">
                        <?php if(!(empty($goodsInfo['cover_path']) || ($goodsInfo['cover_path'] instanceof \think\Collection && $goodsInfo['cover_path']->isEmpty()))): ?>
                        <img src="ROOT_PATH<?php echo $goodsInfo['cover_path']; ?>" width="120" height="120">
                        <?php endif; ?>
                      </div>
                    </div>
                </div>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <div class="box-body">
                <div id="uploader-demo">
                    <!--用来存放item-->
                    <input type="hidden" name="photo_path_1" value="<?php echo $goodsInfo['photo_path_1']; ?>" class="photo_path_1">
                    <div id="photo_path_1" class="uploader-list">
                      <div class="file-item thumbnail upload-state-done">
                        <?php if(!(empty($goodsInfo['photo_path_1']) || ($goodsInfo['photo_path_1'] instanceof \think\Collection && $goodsInfo['photo_path_1']->isEmpty()))): ?>
                        <img src="ROOT_PATH<?php echo $goodsInfo['photo_path_1']; ?>" width="120" height="120">
                        <?php endif; ?>
                      </div>
                    </div>
                </div>
              ...
              <div class="box-body">
                <div id="uploader-demo">
                    <!--用来存放item-->
                    <input type="hidden" name="photo_path_2" value="<?php echo $goodsInfo['photo_path_2']; ?>" class="photo_path_2">
                    <div id="photo_path_2" class="uploader-list">
                      <div class="file-item thumbnail upload-state-done">
                        <?php if(!(empty($goodsInfo['photo_path_2']) || ($goodsInfo['photo_path_2'] instanceof \think\Collection && $goodsInfo['photo_path_2']->isEmpty()))): ?>
                        <img src="ROOT_PATH<?php echo $goodsInfo['photo_path_2']; ?>" width="120" height="120">
                        <?php endif; ?>
                      </div>
                    </div>
                </div>
              ...
              <div class="box-body">
                <div id="uploader-demo">
                    <!--用来存放item-->
                    <input type="hidden" name="photo_path_3"  value="<?php echo $goodsInfo['photo_path_3']; ?>"  class="photo_path_3">
                    <div id="photo_path_3" class="uploader-list">
                      <div class="file-item thumbnail upload-state-done">
                        <?php if(!(empty($goodsInfo['photo_path_3']) || ($goodsInfo['photo_path_3'] instanceof \think\Collection && $goodsInfo['photo_path_3']->isEmpty()))): ?>
                        <img src="ROOT_PATH<?php echo $goodsInfo['photo_path_3']; ?>" width="120" height="120">
                        <?php endif; ?>
                      </div>
                    </div>
                </div>
...
<script type="text/javascript">
  $().ready(function () {
    ...
    <?php if(is_array($categoryList) || $categoryList instanceof \think\Collection): $i = 0; $__LIST__ = $categoryList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
      $("input:checkbox[value='<?php echo $vo['cate_id']; ?>']").attr('checked','true');
    <?php endforeach; endif; else: echo "" ;endif; ?>
