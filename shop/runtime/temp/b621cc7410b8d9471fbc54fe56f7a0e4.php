<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:34:"./themes/default/index/search.html";i:1556087718;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
  ...
  <div class="container">
    ...
    <div class="row list">
      ...
      <div class="col-md-9 left">
        ...
        <div class="left-list">
            <div class="news-list"> 
              <div class="news-img"><a href="<?php echo url('Article/detail?id='.$data['id'].'&category='.$data['category']); ?>"><img src="<?php echo get_posts_cover($data['uuid']); ?>" alt=""></a></div>
              <div class="news-content">
              	<p class="c-title"><a href="<?php echo url('Article/detail?id='.$data['id'].'&category='.$data['category']); ?>"><?php echo $data['title']; ?></a></p>
              	<p class="c-info"><span><?php echo date('Y-m-d',$data['updatetime']); ?></span><span>浏览量：<?php echo $data['view']; ?></span></p>
              	<p class="c-des"><a href="<?php echo url('Article/detail?id='.$data['id'].'&category='.$data['category']); ?>"><?php echo get_val($data['uuid'],'description',85); ?></a></p>
              	<a href="<?php echo url('Article/detail?id='.$data['id'].'&category='.$data['category']); ?>" class="c-but">&nbsp;</a>
              </div>
      ...
      <div class="col-md-3 right">
        <div class="right-list">
          ...
          <div>
          	...
          	<a href="<?php echo url('Article/page?name=registration'); ?>"><div class="icon-right icon icon-4"><span>帮助中心</span></div></a>
          </div>
          <div class="clearfix"></div>
        </div>
        <div class="right-list">
