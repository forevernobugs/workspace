<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:36:"./themes/default/index/register.html";i:1556173199;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
  ...
  <div class="container">
      <div class="row">
        <div class="col-xs-10" style="height:96px">
          <div class="header"><a href="<?php echo url('index/index'); ?>" style="color:#000000">帆帆购物商城</a><span class="line_left">|</span><span ><a href="<?php echo url('base/register'); ?>">会员注册</a></span></div>
          
        </div>
        <div class="col-xs-2 contract"><a href="<?php echo url('index/index'); ?>">返回首页</a><span style="padding:0 5px 0 5px">|</span><span ><a href="<?php echo url('article/page',['name'=>'job']); ?>">联系我们</a></div>
  ...
  <div class="main_register">
    <div class="register">
      ...
      <form action="" method="POST">
        <div class="col-xs-8" style="height:656px" >
          <table class="input-register-table" style="margin-left:100px;margin-top:20px">
                <tr>
