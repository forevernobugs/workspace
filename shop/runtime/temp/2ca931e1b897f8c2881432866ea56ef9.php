...
<aside class="main-sidebar">
  ...
  <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo url('admin/plugin/index'); ?>">插件</a></li>
           ...
           <div class="box box-primary">
            ...
            <div class="tab-pane active" id="activity">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="name" value="<?php echo $adInfo['name']; ?>" placeholder="广告名称" />
                   <input name="id" hidden="hidden" value="<?php echo $adInfo['id']; ?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">广告描述</label>
                  <input type="text" class="form-control" id="description"  value="<?php echo $adInfo['description']; ?>" name="description" placeholder="广告描述" />
                </div>
                 <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="link" value="<?php echo $adInfo['link']; ?>" name="link" placeholder="链接地址">
                </div>
                 <div class="form-group">
                  <label for="exampleInputPassword1">优先级</label>
                  <input type="text" class="form-control" id="level" value="<?php echo $adInfo['level']; ?>" name="level" placeholder="优先级">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">创建时间</label>
                  <input type="text" readonly="time" class="form-control" id="createtime" value="<?php echo date('Y-m-d H:i:s',$adInfo['createtime']); ?>" name="createtime" placeholder="创建时间" />
                </div>
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="box-body cover_show">
                      <div class='form-group'>
                        <img class='cover_path' style='max-height:150px;' src="ROOT_PATH<?php echo $adInfo['banner_path']; ?>">
                      </div>
                    </div>
            ...
            <script type="text/javascript"> 
              $(function(){
                ...
                // 设置select选中
                $(".Select").val("<?php echo $adInfo['position']; ?>");
                $(".status").val("<?php echo $adInfo['status']; ?>");
              })  
