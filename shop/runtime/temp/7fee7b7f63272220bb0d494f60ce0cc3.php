<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:81:"C:\phpStudy\PHPTutorial\WWW\shop/application/admin\view\banner_position\edit.html";i:1471616304;s:72:"C:\phpStudy\PHPTutorial\WWW\shop/application/admin\view\common\head.html";i:1490430462;s:74:"C:\phpStudy\PHPTutorial\WWW\shop/application/admin\view\common\header.html";i:1490430462;s:74:"C:\phpStudy\PHPTutorial\WWW\shop/application/admin\view\common\navbar.html";i:1471616304;s:74:"C:\phpStudy\PHPTutorial\WWW\shop/application/admin\view\common\footer.html";i:1474879114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<aside class="main-sidebar">
  ...
  <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo url('admin/bannerposition/index'); ?>">插件</a></li>
        <li class="active">广告位编辑</li>
      </ol>
    </section>
            ...
            <div class="tab-pane active" id="activity">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text"  class="form-control" id="username" name="title" value="<?php echo $posInfo['title']; ?>"  />
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">宽度</label>
                  <input type="text" class="form-control" id=""  value="<?php echo $posInfo['width']; ?>" name="width"  />
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">高度</label>
                  <input type="text" class="form-control"  value="<?php echo $posInfo['height']; ?>" name="height" />
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">广告位状态</label>
                  <input type="text" class="form-control"  value="<?php echo get_user_status($posInfo['status']); ?>" name="status"/>
                </div>
                
               
                  <input type="hidden" class="form-control" id="id" value="<?php echo $posInfo['id']; ?>" name="id"  />
              <div class="pull-right">
