<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:37:"./themes/default/index/news_list.html";i:1556087386;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
...
<div class="main">
  <div class="container">
    ...
    <div class="news-nav">
      ...
      <span class="nav-nav"><a href="<?php echo url('Index/index'); ?>">首页</a> / <a href="<?php echo url('Article/lists?category='.$categoryInfo['slug']); ?>"><?php echo get_parent_category($categoryInfo['pid'],"name"); ?></a> / <?php echo $categoryInfo['name']; ?></span>
    </div>
    <!-- 新闻导航结束 -->
    <!-- 新闻列表 -->
    <div class="row list">
