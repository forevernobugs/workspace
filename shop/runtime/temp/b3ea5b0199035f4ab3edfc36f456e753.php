            ...
            <div class="box-body no-padding">
              <form method="post" action=<?php echo url('edit'); ?> id="edit">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="group_name" value="<?php echo $group['title']; ?>" placeholder="用户组" type="text">
                    <input name="gid" value="<?php echo $group['id']; ?>" type="hidden">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1" class="nname">简短描述</label>
                    <input class="form-control" name="description" value="<?php echo $group['description']; ?>" placeholder="描述(选填)" type="text">
                  </div>
  ...
  $.widget.bridge('uibutton', $.ui.button);
    ...
    $('.submit').click(function () {
        $.ajax({
          cache: true,
          type: "POST",
          url: '<?php echo url('Authmanager/edit'); ?>',
          data: $('#edit').serialize(),
          async: false,
