<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:33:"./themes/default/index/login.html";i:1557114091;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
  ...
  <div class="container">
      <div class="row">
        <div class="col-xs-10" style="height:96px">
          <div class="header"><a href="<?php echo url('index/index'); ?>" style="color:#000000">帆帆购物商城</a><span class="line_left">|</span><span><a href="<?php echo url('base/login'); ?>">会员登录</a></span></div>          
        </div>
