 ...
 * Time: 21:27
 */
class SaveAgencyAfterIn  extends BaseJob
{
    /**
     * get the queue name
    ...
    protected function realHandler()
    {
        ...
        $result = curl_post_apsapi('aftersales/internal/transport/reReceiptByWarehouse', $params);
        //api日志
        ApiRequestLog::saveLog(
            1, 
            'SaveAgencyAfterIn',
            env('APS_API_URL','').'aftersales/internal/transport/reReceiptByWarehouse',
            json_encode($params),
            $result['msg']
        );
        return $result['msg'];
