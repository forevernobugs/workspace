       ...
       输入：
          <table class='shuru'>
                <tr>
                    ...
                    <td><input type="text" style="width:300px" placeholder="" name="name" required="required" id="A1" datatype="*0-16" nullmsg="用户名不能为空"></td>
                </tr>
                <tr>
                    <td width="100" class="text-r"></td>
                    <td id="ss">
                      <input type="button" name="pro" id="A2" value="键A2"><br>
      ...
      显示：
            ...
            ?>
                <tr class="text-c">
                  ...
                  <td width="100"><?php echo $value['product'] ?></td>
...
<div id="box1" style="display: none">
  <div id="child" style="display: none">
    <select name='pro[]' id="A3" onfocus="selectFocus(this)" onchange="selectChange(this)">
      <option value ="all" >All</option>style="display: none"
      <?php
          foreach ($pro as $key => $value) {
              echo "<option value ='".$key."' onclick='selectClick(this)' ".(($key==$config_category)?'selected':'').">".$value."</option>"; 
          }
      ?>
    </select>
    ...
    <input type="reset" name="" id="A5" value="键A5" onclick="clearA3(this)"><br>
  </div>
</div>
...
<script type="text/javascript">
    ...
    var A3=document.getElementById('child')
    ...
    function selectChange(that){
      //选择下一个select
      var nextthat = that.nextElementSibling
      nextthat.style.display='inline';

          var key = that.selectedIndex;
            if(key !=0){
              //发送post请求
              //第一步 创建ajax对象
